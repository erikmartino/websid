                                     ...
                                     LVM_UINT16                 NumSamples)
{
    ...
    if(err !=LVCS_SUCCESS)
    {
		fprintf(stderr, "error: LVCS_ReverbGenerator %u\n", err);
        return err;
    }
    /*
     * Call the equaliser
    ...
    if(err !=LVCS_SUCCESS)
    {
 		fprintf(stderr, "error: LVCS_Equaliser %u\n", err);
       return err;
    }
    /*
    ...
    if(err !=LVCS_SUCCESS)
    {
 		fprintf(stderr, "error: LVCS_BypassMixer %u\n", err);
        return err;
    }
                                  ...
                                  LVM_UINT16                NumSamples)
{
    ...
    {
		fprintf(stderr, "XX %d > %d\n", NumSamples, pInstance->Capabilities.MaxBlockSize);
